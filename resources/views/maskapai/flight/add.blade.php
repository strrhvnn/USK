<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
        <form action="{{ route('maskapai.flight.store') }}" method="POST">
            @csrf
            ...
            <div class="form-control mt-3">
                ...
                <input type="text" class="input input-bordered w-full max-w-xs" name="seat_availability" id="seat_availability"> <!-- Sesuaikan dengan nama field di controller -->
            </div>
            <div class="form-control mt-3">
