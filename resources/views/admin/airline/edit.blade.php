<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <form action="{{ route('admin.airline.update',$airlines->id) }}" method="POST">
            @csrf
            <div class="form-control mt-3">
                <label for="name">Id Airlines</label>
                <input type="text" class="input input-bordered w-full max-w-xs" name="name" id="name" value="{{ $airlines->id }}">
            </div>
            <div class="form-control mt-3">
